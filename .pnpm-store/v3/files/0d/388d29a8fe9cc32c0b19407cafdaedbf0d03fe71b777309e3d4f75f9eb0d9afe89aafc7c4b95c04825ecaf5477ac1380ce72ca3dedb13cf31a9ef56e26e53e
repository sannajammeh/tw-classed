...
var Input = forwardRefWithAs(function Input2(props, ref) {
  ...
  let isComposing = (0, import_react17.useRef)(false);
...
var MenuRoot = forwardRefWithAs(function Menu(props, ref) {
  ...
  let slot = (0, import_react31.useMemo)(() => ({ open: menuState === 0 /* Open */, close }), [menuState, close]);
  let theirProps = props;
...
var Item = forwardRefWithAs(function Item2(props, ref) {
  ...
  let slot = (0, import_react31.useMemo)(() => ({ active, disabled, close }), [active, disabled, close]);
  let ourProps = {
    id: id2,
    ref: itemRef,
    role: "menuitem",
...
var Button9 = forwardRefWithAs(function Button10(props, ref) {
  ...
  let isWithinPanel = panelContext === null ? false : panelContext === state2.panelId;
  let buttonRef = useSyncRefs(internalButtonRef, ref, isWithinPanel ? null : (button) => button && dispatch({ type: 2 /* SetButton */, button }));
