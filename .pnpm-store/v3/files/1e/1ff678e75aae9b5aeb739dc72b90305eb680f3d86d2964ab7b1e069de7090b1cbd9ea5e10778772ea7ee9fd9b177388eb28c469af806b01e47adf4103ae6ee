...
async function writeChangeset(changeset, cwd) {
  ...
  return await fs__default.default.writeFile(newChangesetPath, await prettierInstance.format(changesetContents, _objectSpread2(_objectSpread2({}, prettierConfig), {}, {
    parser: "markdown"
  }))), changesetID;
}
