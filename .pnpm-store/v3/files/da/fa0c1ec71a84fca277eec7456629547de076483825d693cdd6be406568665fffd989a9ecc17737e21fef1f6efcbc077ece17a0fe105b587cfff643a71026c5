...
const NextSeo = ({
  ...
  languageAlternates,
  additionalLinkTags,
  useAppDir: _useAppDir = false
}) => {
  return /*#__PURE__*/React.createElement(React.Fragment, null, _useAppDir ? buildTags({
    title,
    themeColor,
    noindex: _noindex,
    nofollow,
...
const _excluded$s = ["type", "keyOverride", "url", "title", "images", "section", "dateCreated", "datePublished", "dateModified", "authorName", "publisherName", "publisherLogo", "body", "isAccessibleForFree"];
